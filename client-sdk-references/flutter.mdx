...
<CardGroup>
  ...
  The PowerSync Flutter/Dart SDK is distributed via pub.dev [[External link].](https://pub.dev/packages/powersync)
  </Card>
...
<Info>
  Web support is currently in an alpha release. Refer to [Flutter Web Support (Alpha)](/client-sdk-references/flutter/flutter-web-support-alpha) for more details.
</Info>
...
To access the source code for this SDK, refer to the [powersync.dart](https://github.com/powersync-ja/powersync.dart) repo on GitHub.
