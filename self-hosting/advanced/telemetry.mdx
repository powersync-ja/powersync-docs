...
<Tip>To scrape your self-hosted PowerSync Service metrics, please see the [Metrics](/self-hosting/advanced/metrics) docs page for more details.</Tip>

### Opting Out

To disable the sending of telemetry to PowerSync, set the `disable_telemetry_sharing` key in your [configuration file](/self-hosting/configuration/service-configuration) (`config.yaml` or `config.json`) to `true`:
