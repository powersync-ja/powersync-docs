...
<CardGroup>
  ...
  <Card title="Understand PowerSync" icon="lightbulb" href="/intro/powersync-philosophy" horizontal>
    PowerSync's core concepts, architecture, and the philosophy behind our sync engine.
  </Card>
  <Card title="AI Agent Skills" icon="sparkles" href="/tools/ai-tools#powersync-agent-skills" horizontal>
   ...
   <Card title="Migrate from Atlas Device Sync" icon="leaf" href="/migration-guides/atlas-device-sync" horizontal>
...
<CardGroup cols={4}>
  ...
  <Card title="MySQL (Beta)" icon="dolphin" href="/configuration/source-db/setup#mysql-beta" />

  <Card title="SQL Server (Alpha)" icon="server" href="/configuration/source-db/setup#sql-server-alpha" />
</CardGroup>
