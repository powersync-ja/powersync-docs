...
| **Kotlin**                    | [powersync-attachments](https://github.com/powersync-ja/powersync-kotlin/tree/main/core/src/commonMain/kotlin/com/powersync/attachments) | [To-Do List demo app](https://github.com/powersync-ja/powersync-kotlin/tree/main/demos/android-supabase-todolist) |
| **Swift**                     | [PowerSyncAttachments](https://github.com/powersync-ja/powersync-swift/tree/main/Sources/PowerSyncAttachments) | [To-Do List demo app](https://github.com/powersync-ja/powersync-swift/tree/main/Examples/SupabaseTodoList) |
