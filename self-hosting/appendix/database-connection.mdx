...
1. The Username and Password is the `powersync_role` created in [Source Database Setup](/usage/installation/database-setup).
...
* The Username and Password is the `powersync_role` created in [Source Database Setup](/usage/installation/database-setup).
