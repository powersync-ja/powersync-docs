...
description: "Configure self-hosted PowerSync Service deployments using YAML or environment variables for database connections, auth, storage, and sync rules."
