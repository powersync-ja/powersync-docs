...
sidebarTitle: "Nuxt"
description: "Integrate PowerSync with Nuxt for offline-first Vue applications, including plugin setup, composable usage, and server-side rendering support."
