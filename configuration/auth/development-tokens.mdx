...
description: "Generate temporary development tokens for testing PowerSync authentication and Sync Streams without integrating a full identity or auth provider."
---
