...
<Warning>
  This SDK is currently in an [**alpha** release](/resources/feature-status) for the purpose of gathering external feedback. It is not suitable for production use as breaking changes may still occur.
  We also can't guarantee continued support for the SDK at this time.
  If you're interested in using the PowerSync Rust SDK, please [contact us](/contact) with details about your use case.
</Warning>
