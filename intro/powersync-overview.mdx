...
<CardGroup cols={3}>
  ...
  <Card title="MySQL" icon="dolphin" href="/usage/installation/database-setup/#mysql-alpha">
  Currently in an alpha release.
  </Card>
</CardGroup>
...
<CardGroup cols={3}>
  ...
  <Card title="Monitoring and alerting" icon="bell" href="/usage/tools/monitoring-and-alerting">
