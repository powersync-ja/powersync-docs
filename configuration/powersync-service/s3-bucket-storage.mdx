...
S3 bucket storage is [Beta](/resources/feature-status) in PowerSync Service v1.26.0. It uses storage version 4, which has a stable storage format. S3 bucket storage itself remains Beta.
