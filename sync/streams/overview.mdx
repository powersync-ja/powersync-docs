...
Sync Streams are now in beta and production-ready. We recommend Sync Streams for all new projects.

Sync Streams will ultimately replace the current Sync Rules system. Sync Rules will continue to be supported for existing projects, but we recommend migrating to Sync Streams.

We welcome your feedback on Sync Streams — please share with us in [Discord](https://discord.gg/powersync).
</Note>
