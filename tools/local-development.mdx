...
description: "Set up PowerSync locally for development using Docker and the PowerSync CLI, including a local PowerSync Service, source database, and test client."
---
