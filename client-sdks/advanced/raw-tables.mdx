...
<Warning>
  Raw tables are not currently compatible with the [High Performance Diffs](/client-sdks/advanced/high-performance-diffs) feature available in our JavaScript SDKs.
</Warning>
