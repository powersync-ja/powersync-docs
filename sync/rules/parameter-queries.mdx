...
description: "Define bucket parameters in Sync Rules using Parameter Queries with JWT claims and client parameters."
---

<Info>
Sync Rules are deprecated. For the Sync Streams equivalent, see [Using Parameters](/sync/streams/parameters).
</Info>
