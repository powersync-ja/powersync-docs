...
1. Pre-processes the data according to the [Sync Streams](/usage/sync-streams) (both data queries and parameter queries), splitting data into [sync buckets](/usage/sync-rules/organize-data-into-buckets) and transforming the data if required.
