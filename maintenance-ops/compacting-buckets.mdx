...
description: "Reduce storage and sync overhead by compacting and defragmenting PowerSync buckets to remove redundant operations and shrink the operation history."
---
