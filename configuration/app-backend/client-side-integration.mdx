...
<CardGroup cols={3}>
  ...
  <Card title="Tauri (experimental)" icon="/logo/tauri_sidebar.svg" href="/client-sdks/reference/tauri#3-integrate-with-your-backend" />
  ...
  <Card title="Rust (experimental)" icon="rust" href="/client-sdks/reference/rust#3-integrate-with-your-backend" />
</CardGroup>
