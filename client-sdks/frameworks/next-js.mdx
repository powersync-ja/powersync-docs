...
description: "Build highly responsive, offline-capable Next.js applications with PowerSync using client components, dynamic imports, and the JavaScript Web SDK."
