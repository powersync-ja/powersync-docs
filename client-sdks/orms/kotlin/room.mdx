---
title: "Room (Alpha)"
description: "Use Android Room with PowerSync's Kotlin SDK for compile-time-checked DAOs, LiveData/Flow integration, and Android-native query support (alpha)."
---
