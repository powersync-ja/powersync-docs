...
<Steps>
  ...
  <Step title="Define Basic Sync Rules">
    Define [Sync Rules](/usage/sync-rules) (or [Sync Streams](/usage/sync-streams.md)) in PowerSync — this enables dynamic partial replication: syncing just a relevant subset of data to each user/client instead of your entire database.
