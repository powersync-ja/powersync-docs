...
description: "Network architecture and security guidance for self-hosted PowerSync deployments, including TLS, firewalls, secrets management, and access controls."
---
