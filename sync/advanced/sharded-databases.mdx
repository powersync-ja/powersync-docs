...
description: "Sync data from sharded Postgres databases using per-shard PowerSync connection configuration, including sharding by tenant or geographic region."
---
