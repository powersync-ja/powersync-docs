...
description: "Optimize the Supabase connector in PowerSync apps for higher throughput, faster writes, and reduced latency between your client and Supabase backend."
---
