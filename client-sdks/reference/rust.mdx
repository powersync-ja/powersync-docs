...
description: "Complete setup and usage guide for the PowerSync Rust SDK (alpha), covering installation, schema definition, database connection, and sync config."
