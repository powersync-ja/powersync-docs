...
In the JavaScript/TypeScript SDK, apps that transfer large files can replace this adapter with a streaming transport on React Native and Node.js; see [Transferring Large Files Without Buffering](#transferring-large-files-without-buffering).
