...
description: "Some use cases require data persistence before the user has registered / signed in. In some of those cases, the user may want to register and start syncing data with other devices or users at a later point, while other users may keep on using the app without ever registering or going online."
---
