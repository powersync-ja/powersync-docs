...
Filters are evaluated against the matching field on each log entry. Unknown-field chips render in a different color so you can tell them apart from the known aliases.
