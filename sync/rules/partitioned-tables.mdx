...
{/* Split page: the Sync Streams version of this page is sync/advanced/partitioned-tables.mdx. This page is deprecated and frozen: no new features or examples. When you fix an error here, check whether the Sync Streams page needs the same fix. */}

<Info>
Sync Rules are deprecated. This page is not updated with new features. For the Sync Streams version, see [Partitioned Tables (Postgres)](/sync/advanced/partitioned-tables).
</Info>
