...
```text
Set up PowerSync in this project using the PowerSync Tauri SDK.

Install the PowerSync Agent Skills in this project and follow them:

    npx skills add powersync-ja/agent-skills

Use https://docs.powersync.com/client-sdks/reference/tauri.md as the SDK
...
5. Do I need to read or write the database from Rust code as well as from
   JavaScript?
