...
<Note>
PowerSync's per-user limits are generous, but some designs reach them quickly. If your app has users who belong to many organizations, syncs deep hierarchies at once, uses many-to-many relationships, or gives each user a very large dataset, this page explains how buckets are counted so you can keep your Sync Streams within the limits and your costs predictable.
</Note>
