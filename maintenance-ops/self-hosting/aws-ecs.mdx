...
description: "Deploy the self-hosted PowerSync Service on AWS ECS with Fargate, including task definitions, networking, secrets management, and load balancer setup."
---
