...
description: "Set up local development with Supabase and PowerSync using the Supabase CLI, a local Postgres instance, and a self-hosted PowerSync Service in Docker."
---
