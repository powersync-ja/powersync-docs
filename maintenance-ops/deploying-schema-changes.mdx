...
description: "Procedures for safely deploying schema changes when using PowerSync, including coordinating client SDK updates, Sync Streams changes, and rollouts."
