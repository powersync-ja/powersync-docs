...
The client-side database can be encrypted at rest using .
...
<Card
  ...
  icon="npm"
  href="https://www.npmjs.com/package/@powersync/webe"
  horizontal
/>
...
<Note>
  Support for encryption on other platforms is planned. In the meantime, let us know with your needs and use cases on [Discord](https://discord.gg/powersync).
</Note>
