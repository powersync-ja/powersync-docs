...
<Prompt description="Add **PowerSync** to your project" actions={["copy"]} icon="sparkles">
```text
Set up PowerSync in this project using the PowerSync JavaScript Web SDK.

Install the PowerSync Agent Skills in this project and follow them:

    npx skills add powersync-ja/agent-skills

Use https://docs.powersync.com/client-sdks/reference/javascript-web.md as
the SDK reference. When something is unclear, check the PowerSync docs or
ask me. Do not invent APIs.
...
5. Which framework am I using (React, Vue, or plain JavaScript), and does
   the app need to stay in sync across multiple browser tabs?
