...
description: "Configure self-hosted PowerSync Service deployments using YAML files or environment variables, including database, replication, and runtime options."
