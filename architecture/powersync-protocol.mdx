...
description: "Technical overview of the sync protocol between PowerSync clients and the Service, including buckets, operations, checkpoints, and incremental streaming."
---
