...
description: "Restrict source database access to PowerSync Cloud using static IP allowlisting per deployment region for AWS, GCP, and Azure database firewalls."
---
