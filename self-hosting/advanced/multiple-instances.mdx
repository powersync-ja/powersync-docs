...
<Warning>
Multiple instances are not required in most cases. See the [Deployment Architecture](/self-hosting/advanced/production-setup) for details on standard horizontal scaling setups.
</Warning>
...
This setup is described in the [Deployment Architecture](/self-hosting/advanced/production-setup).
