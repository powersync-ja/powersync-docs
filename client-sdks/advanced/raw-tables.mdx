...
description: "Use raw SQLite tables to bypass the default JSON view structure for native SQLite functionality, custom indexes, and improved query performance."
sidebarTitle: "Raw SQLite Tables"
---

<Warning>
  Raw tables are not currently compatible with the [High Performance Diffs](/client-sdks/high-performance-diffs) feature available in our JavaScript SDKs.
</Warning>
