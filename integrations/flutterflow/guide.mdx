...
description: "Build local-first offline-capable apps with FlutterFlow and PowerSync using Supabase as the backend, with step-by-step integration instructions."
