...
## <Icon icon="server" iconType="solid" size={32}/> SQL Server/Azure SQL (Alpha) Specifics
...
<Info>
    Make sure that your SQL Server/Azure SQL database allows access to PowerSync's IPs — see [Security and IP Filtering](/installation/database-setup/security-and-ip-filtering)
</Info>
