...
PowerSync is designed to be stack agnostic, and currently supports [Postgres](/installation/database-setup#postgres), [MongoDB](/installation/database-setup#mongodb), [MySQL](/installation/database-setup#mysql-beta) (Beta), and [SQL Server/Azure SQL](/installation/database-setup#sql-server-alpha) (Alpha) as the backend source database, and has the following official client-side SDKs available:
- [**Dart/Flutter**](/client-sdk-references/flutter) (mobile and [web](/client-sdk-references/flutter/flutter-web-support)) 
...
- [**JavaScript Web**](/client-sdk-references/javascript-web) (including integrations for React, Vue and TanStack)
- [**Capacitor**](/client-sdk-references/capacitor) (alpha)
- [**Node.js**](/client-sdk-references/node) (beta)
- [**Kotlin**](/client-sdk-references/kotlin)
