...
The growth rate of the WAL is typically expected to excessively increase during initial replication of large datasets with high frequency of updates, for tables in the publication you created for PowerSync, during the initial replication. i.e. when you start a new PowerSync Service instance or when new Sync Rules are deployed.
