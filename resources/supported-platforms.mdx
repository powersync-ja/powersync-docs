...
| JS | Experimental | – | Added in SDK v1.14.0. Unstable and not ready for production — see [Experimental Web Support](/client-sdks/reference/kotlin#experimental-web-support). |
| WebAssembly | Experimental | – | Added in SDK v1.14.0. Unstable and not ready for production — see [Experimental Web Support](/client-sdks/reference/kotlin#experimental-web-support). |
| HTTP connection method | Yes | – | |
