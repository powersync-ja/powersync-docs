...
description: "Use PowerSync as a local SQLite database for offline-only data persistence without backend sync, authentication, or a configured PowerSync Service."
---
