...
You can show users a progress bar when data downloads using the `downloadProgress` property from the [SyncStatus](https://todo) class. `downloadProgress.fraction` gives you a value from 0.0 to 1.0 representing the total sync progress. This is especially useful for long-running initial syncs.
...
Also see:
- [SyncStatus API](https://todo)
- [Demo component](https://todo)