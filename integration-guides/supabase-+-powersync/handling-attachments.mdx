...
Our Flutter [To-Do List demo app](https://github.com/powersync-ja/powersync.dart/tree/master/demos/supabase-todolist) showcases how to sync attachments (such as photos) using our new attachments library under `package:powersync_core/attachments/attachments.dart`, which offers improved APIs over the previous [powersync_attachments_helper](https://pub.dev/packages/powersync_attachments_helper) package. See the docs here: [powersync_core attachments](https://github.com/powersync-ja/powersync.dart/tree/main/packages/powersync_core/doc/attachments.md).
