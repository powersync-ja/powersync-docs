...
description: "How Postgres, MongoDB, MySQL, and SQL Server types map to PowerSync's SQLite-based sync column definitions, including arrays, JSON, dates, and binary data."
---
