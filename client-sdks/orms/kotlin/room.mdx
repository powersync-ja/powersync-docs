...
class PowerSyncConnectionFactoryAsSqliteDriver(
    ...
    override fun open(fileName: String): SQLiteConnection {
        ...
        return factory.openConnection(dbFilename = path.name, dbDirectory = path.parent?.toString(), readOnly = false)
    }
}
```
...
// Example for Android, all other KMP targets are supported too.
