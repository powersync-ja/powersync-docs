...
description: "Subscribe to live queries that re-run automatically when local SQLite data changes, including streaming and incremental query options across SDKs."
---
