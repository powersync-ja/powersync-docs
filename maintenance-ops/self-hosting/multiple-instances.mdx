...
description: "Run multiple self-hosted PowerSync Service instances for load distribution, high availability, and zero-downtime deployments behind a load balancer."
---
