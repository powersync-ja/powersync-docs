...
Support for React Native Web is available since versions 1.12.1 of the PowerSync [React Native SDK](/client-sdks/guides/react-native-and-expo) and 1.8.0 if the [JavaScript Web SDK](/client-sdks/guides/javascript-web), and is currently in a **beta** release.
</Note>
...
The [PowerSync Web SDK](/client-sdks/guides/javascript-web), alongside the [PowerSync React Native SDK](/client-sdks/guides/react-native-and-expo), is required for Web support.
