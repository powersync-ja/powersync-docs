...
2. Provide the following details:
   ...
   * **Region**: the PowerSync region to create the Private Endpoint in. This must match the region of the PowerSync instance you plan to use the endpoint with. The region of the underlying AWS PrivateLink Endpoint Service does not need to match. It can be in any region.
3. Click **Create**.
