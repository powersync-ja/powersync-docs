...
<Warning>
Version 1.14.0 and later of `com.powersync:integration-room` requires [Room 3.0](https://developer.android.com/jetpack/androidx/releases/room3). If your app still uses Room 2.x, upgrade your Room dependency to 3.0 before updating the integration.
</Warning>
