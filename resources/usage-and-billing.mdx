...
If your instance is deprovisioned, you can easily restart it from the [Dashboard](/usage/tools/powersync-dashboard) or [CLI](/usage/tools/cli) by deploying Sync Rules to it. Note that this will reprocess your Sync Rules from scratch, causing data to re-sync to existing users.
