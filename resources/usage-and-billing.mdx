...
Usage limits for PowerSync Cloud are specified on our [Pricing page](https://www.powersync.com/pricing). If your usage exceeds the included amounts, see [Reducing Usage](/resources/usage-and-billing/reducing-usage) for ways to bring it down.
