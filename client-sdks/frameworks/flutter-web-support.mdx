...
description: "Configure the PowerSync Flutter SDK for web with Chrome, WASM SQLite, and shared workers to run offline-first Flutter apps in the browser (Beta)."
