---
title: "Firebase Auth"
description: "Configure Firebase Authentication as the auth provider for PowerSync by verifying Firebase-issued JWTs and using Firebase user IDs in Sync Streams."
---
