...
description: "Implement cascading deletes in client-side SQLite using triggers and upload queue handlers to remove related rows when a parent record is deleted."
