When creating a project in the [PowerSync Dashboard](https://dashboard.powersync.com/), a Development and Production instance will be created by default. Select the instance you want to configure.
