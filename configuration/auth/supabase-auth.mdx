---
title: "Supabase Auth"
description: "Use Supabase Auth as the identity provider for PowerSync by verifying Supabase JWTs directly and using Supabase user claims in Sync Streams parameters."
...
These examples show how to implement [`fetchCredentials()` in your client-side _backend connector_](/configuration/app-backend/client-side-integration#‘backend-connector’) to get the Supabase JWT from the Supabase Client Library:
