...
* [Coolify](/maintenance-ops/self-hosting/coolify): This can simplify the setup and management of the deployment.
* [Railway](/maintenance-ops/self-hosting/railway)
* [AWS ECS](/maintenance-ops/self-hosting/aws-ecs)
