...
Connect your PowerSync database to the PowerSync Service instance you created in [step 1](#1-set-up-powersync-service-instance) by defining a _backend connector_ and calling `connect()`. The backend connector handles authentication and uploading writes to your backend.
