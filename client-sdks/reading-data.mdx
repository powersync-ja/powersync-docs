...
PowerSync integrates with popular ORM libraries. Using an ORM is often preferable to writing raw SQL queries, as they provide type safety and other benefits.
To learn more, see [ORMs Overview](/client-sdks/orms/overview).
