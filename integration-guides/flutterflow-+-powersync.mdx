...
Of course, you may want to to store other values in your PostgreSQL database as well. When syncing a value that doesn't
...
Finally, the PowerSync mapping also needs to be reverted when uploading rows to PostgreSQL. For a
...
This allows you to customize how individual values are represented for PostgreSQL. In this case, the `tags`
