...
description: "Implement custom conflict resolution in PowerSync when concurrent updates from multiple offline clients write to the same rows in the source database."
---
