...
<Info>
  For more details on PowerSync's general architecture, [see here](https://github.com/powersync-ja/docs-powersync-gitbook/blob/docs/integration-guides/supabase-+-powersync/broken-reference/README.md).
</Info>
...
3. Under the "**General**" tab, you can change the default cloud region from US to EU or JP if desired (more cloud regions are available, [contact us](/resources/contact-us) if you need a different region).
...
<Frame>
  <img src="/images/integration-6.png"/>
</Frame>
...
Note that the PowerSync Kotlin Multiplatform SDK is currently in a beta release.
...
_Note that the PowerSync Kotlin Multiplatform SDK is currently in a beta release._
  </Tab>
  <Tab title="Swift">
Edit the `_Secrets` file and insert the necessary credentials as detailed below.

_Note that the PowerSync Swift SDK is currently in an alpha release._
  </Tab>
</Tabs>
...
<Frame>
  <img src="/images/integration-7.png"/>
</Frame>
#### Run the app
...
<Frame caption="Flutter demo app login screen">
  <img src="/images/integration-8.png"/>
</Frame>
