...
description: "Get row-level change notifications using trigger-based table diffs in the PowerSync JavaScript SDKs for high-performance reactive UI updates (experimental)."
---
