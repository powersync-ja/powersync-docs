---
title: "Log Reference"
description: "Reference for reading PowerSync Service logs: what the structured fields mean, what common log lines indicate, and whether each one needs action."
