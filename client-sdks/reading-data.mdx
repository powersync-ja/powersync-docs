---
title: "Reading Data"
description: "Query data from your local SQLite database using SQL and the PowerSync SDK, including one-shot reads, watch queries, and reactive UI integration."
