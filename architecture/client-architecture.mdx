...
description: "How the PowerSync Client SDK manages the connection to the Service, the local SQLite database, the client-side schema, and the upload queue for writes."
---
