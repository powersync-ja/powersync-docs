---
title: "Advanced SQL Server Configuration"
description: "Configure advanced SQL Server adapter options for self-hosted PowerSync, including CDC tuning, polling intervals, and per-table replication settings."
sidebarTitle: "Advanced SQL Server Config (Self-Hosted)"
---
...
Update your `service.yaml` file to use the Service Principal for authentication:
...
The below configuration options can be set in the `additionalConfig` section under the `connections` section of the `service.yaml` file.
