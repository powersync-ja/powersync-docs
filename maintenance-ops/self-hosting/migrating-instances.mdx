...
If the PowerSync instances use the same source database and have the same basic configuration and Sync Streams or Sync Rules, you can migrate users by just changing the endpoint to the new instance.
