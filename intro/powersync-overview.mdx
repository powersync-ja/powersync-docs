...
<CardGroup cols={4}>
  <Card title="Postgres" icon="elephant" href="/installation/database-setup/#postgres" horizontal />

  <Card title="MongoDB" icon="leaf" href="/installation/database-setup/#mongodb" horizontal />

  <Card title="MySQL (Beta)" icon="dolphin" href="/installation/database-setup/#mysql-beta" horizontal />

  <Card title="SQL Server (Alpha)" icon="server" href="/installation/database-setup/#sql-server-alpha" horizontal />
</CardGroup>
