...
description: "This page last updated on 2024-10-16"
---
...
* Hosted by us: Refer to [Database Connection](../../usage/installation/database-connection#mongodb-alpha-specifics)
...
1. Connect your database to an instance of the PowerSync Service:
   1. Using PowerSync Cloud (hosted by us): See [Database Connection](../../usage/installation/database-connection#mongodb-alpha-specifics)
