...
description: "Diagnose and fix common PowerSync issues using logs, the Diagnostics App, the dashboard, and SDK utilities for replication, auth, and sync errors."
---
