...
description: "How PowerSync handles schema changes across Postgres, MongoDB, MySQL, and SQL Server during replication, including additive and breaking changes."
---
