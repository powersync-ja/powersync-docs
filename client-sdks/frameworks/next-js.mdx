...
description: "Learn how to build highly responsive Next.js applications with PowerSync."
keywords: ["next.js", "web"]
---

## Introduction

This guide shows you how to add PowerSync to a Next.js app for local-first data and sync benefits such as instant interactions and realtime updates between users & devices. You install the Web SDK, define a client-side schema, and connect sync so components query the local database instead of blocking on the network.
...
import { type CommonPowerSyncDatabase, type PowerSyncBackendConnector, UpdateType } from '@powersync/web';
