...
<AccordionGroup>
  ...
  <Accordion title="What is the difference between data replicated vs data synced?">
    Data replicated refers to activity from your backend database (Postgres, MongoDB, MySQL, or SQL Server/Azure SQL database) to the PowerSync Service — this is not billed.
