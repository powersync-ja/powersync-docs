---
title: "Consistency"
description: "How PowerSync uses checkpoints and causal+ consistency to keep client data consistent with the backend."
---
...
There is no single correct choice for handling write failures like these. The best action depends on the specific application and scenario. However, we do have some suggestions for general approaches:
