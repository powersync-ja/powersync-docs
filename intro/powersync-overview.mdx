...
<CardGroup cols={3}>
  <Card title="Sync Streams" icon="filter" href="/usage/sync-streams">
    Sync Streams control which data gets synchronized to users' devices - learn everything you need to know about sync streams.
  </Card>
