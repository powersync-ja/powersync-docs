---
title: "Compatibility"
description: "Configure compatibility editions and bucket storage format versions in PowerSync sync config to manage upgrades, breaking changes, and rollouts."
---
