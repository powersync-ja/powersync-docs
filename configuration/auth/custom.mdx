...
description: "Implement custom JWT-based authentication for PowerSync using any auth provider, including JWKS configuration, signing, and token endpoint setup."
---
