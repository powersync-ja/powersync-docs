...
description: "Run PowerSync sync operations while your app is in the background to keep local data fresh on iOS, Android, and other platforms with native scheduling."
---
