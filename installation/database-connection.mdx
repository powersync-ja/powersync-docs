...
2. Add all the required binlog configuration parameters:
   <Frame>
...
1. Fill in your MySQL connection details:
   ...
   2. "**Host**" the endpoint for your database.
   3. "**Database name**" is the default database to replicate. Additional databases are derived by qualifying the tables in the sync rules.
