...
description: "Understand legacy Sync Rules for controlling which data syncs to each client, with explicit bucket definitions and parameter query configuration."
---
