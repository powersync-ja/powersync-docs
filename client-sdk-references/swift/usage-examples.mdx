...
Use [`watch`](https://powersync-ja.github.io/powersync-swift/documentation/powersync/queries/watch(sql:parameters:mapper:)) to watch for changes to the dependent tables of any SQL query.
...
Use [`execute`](https://powersync-ja.github.io/powersync-swift/documentation/powersync/queries/execute(sql:parameters:)) to run INSERT, UPDATE or DELETE queries.
...
Override [`uploadData`](https://powersync-ja.github.io/powersync-swift/documentation/powersync/powersyncbackendconnector/uploaddata(database:)) to send local updates to your backend service.
...
You can show users a progress bar when data downloads using the `downloadProgress` property from the [`SyncStatusData`](https://powersync-ja.github.io/powersync-swift/documentation/powersync/syncstatusdata/) object. This property gives you a value from 0.0 to 1.0 representing the total sync progress. This is especially useful for long-running initial syncs.
