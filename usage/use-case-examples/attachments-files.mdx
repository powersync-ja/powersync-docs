...
When watching multiple attachment types, you need to provide the `fileExtension` (or `filename`) for each attachment. You can store this in your data model tables or derive it from other fields. Here are examples for both patterns:
