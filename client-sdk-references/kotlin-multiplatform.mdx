...
1. `PowerSyncBackendConnector.fetchCredentials` \- This is called every couple of minutes and is used to obtain credentials for your app backend API. -> See [Authentication Setup](/usage/installation/authentication-setup) for instructions on how the credentials should be generated.
...
class MyConnector : PowerSyncBackendConnector() {
    override suspend fun fetchCredentials(): PowerSyncCredentials {
        ...
        return {
            ...
            // Use a development token (see Authentication Setup https://docs.powersync.com/usage/installation/authentication-setup/development-tokens) to get up and running quickly) to get up and running quickly
...
To access the source code for this SDK, refer to [powersync-kotlin](https://github.com/powersync-ja/powersync-kotlin/) repo on GitHub.
