...
description: "Demo apps and example projects showcasing PowerSync across all supported platforms and backends."
---
...
<AccordionGroup>
  <Accordion title="React Native & Expo" icon="react">
    ...
    - [React Native Barebones Demo](https://github.com/powersync-ja/powersync-js/tree/main/demos/react-native-barebones)
      - This is a barebones example of using PowerSync in a plain React Native app without Expo or any other framework. See [here](/client-sdks/reference/react-native-and-expo#installation) for more background.
  </Accordion>
  <Accordion title="JavaScript Web" icon="js">
    ...
    - [PowerSync Convex To-Do List Demo](https://github.com/powersync-community/powersync-convex-todolist-demo) - JavaScript demo app using Convex as the source backend.
  ...
  <Accordion title="Tauri (alpha)" icon="/logo/tauri.svg">
    #### Examples
...
<Card title="GitHub - powersync-community" icon="github" href="https://github.com/powersync-community" horizontal />
