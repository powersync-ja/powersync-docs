...
```text
Set up PowerSync in this project using the PowerSync Kotlin Multiplatform
SDK.
...
Use https://docs.powersync.com/client-sdks/reference/kotlin.md as the SDK
...
5. Which targets does my app build for (for example Android and iOS), or is
   it Android-only?
