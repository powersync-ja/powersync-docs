...
* Hosted by us: Refer to [database-connection.md](../../usage/installation/database-connection.mdx)
...
1. Connect your database to an instance of the PowerSync Service:
   1. Using PowerSync Cloud (hosted by us): See [database-connection.md](../../usage/installation/database-connection.mdx)
