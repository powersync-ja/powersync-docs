...
description: "Filter synced data dynamically using subscription, auth, and connection parameters in Sync Streams queries to control per-user and per-context data access."
---
