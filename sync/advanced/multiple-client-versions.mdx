...
description: "Handle multiple client app versions that require different output schemas from Sync Streams, including versioned streams and backward compatibility."
---
