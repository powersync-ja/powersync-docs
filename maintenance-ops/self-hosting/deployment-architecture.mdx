...
description: "Infrastructure and sizing recommendations for self-hosted PowerSync in staging and production."
...
We recommend using Git to back up your configuration files.
...
For detailed information on backup strategies and recovery procedures, including what happens when you restore your source database, see [Restoring Source Database](/configuration/source-db/backup-restore).
