...
sidebarTitle: "Nuxt"
description: "Integrate PowerSync with Nuxt to build offline-first Vue 3 applications, including SSR-safe initialization and reactive composables for live queries."
