...
```text
Set up PowerSync in this project using the PowerSync Node.js client SDK.

Install the PowerSync Agent Skills in this project and follow them:

    npx skills add powersync-ja/agent-skills

Use https://docs.powersync.com/client-sdks/reference/node.md as the SDK
...
5. What kind of app is this (for example a CLI or a desktop app), and where
   should the local database file live? If I actually want to connect a
   Node.js backend that serves other PowerSync clients, stop and point me to
   https://docs.powersync.com/configuration/app-backend/setup.md instead.
