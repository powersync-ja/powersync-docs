...
1. `PowerSyncBackendConnectorProtocol.fetchCredentials` - This method will be automatically invoked by the PowerSync client SDK every couple of minutes to obtain authentication credentials. See [Authentication Setup](/installation/authentication-setup) for instructions on how the credentials should be generated.
