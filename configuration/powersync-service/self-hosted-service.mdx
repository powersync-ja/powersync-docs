---
title: "PowerSync Service Configuration"
description: "Configure the PowerSync Service for self-hosted deployments."
sidebarTitle: "PowerSync Service Configuration (Self-Hosting)"
---
...
For sync bucket storage configuration, see [Sync Bucket Storage](/configuration/powersync-service/sync-bucket-storage).
