...
```
    ...
    **Common database locations:**
    - React Native (old directory used when the app was originally installed on a 1.x SDK version): `/data/data/com.package-name/files/`.
    - React Native (new directory): `/data/data/com.package-name/databases/`.
...
4. **PowerSync metadata**: System tables and views for managing sync state (see [Client Architecture](/architecture/client-architecture#client-side-schema-and-sqlite-database-structure))
