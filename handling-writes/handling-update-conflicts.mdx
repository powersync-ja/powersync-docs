...
description: "Understand how PowerSync resolves conflicts when multiple users update the same records while offline, including last-write-wins and custom strategies."
---
