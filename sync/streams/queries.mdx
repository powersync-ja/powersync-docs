...
description: "Learn Sync Streams query syntax for filtering rows, selecting columns, transforming types, and joining tables to define exactly what data syncs to clients."
