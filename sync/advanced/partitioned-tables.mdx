...
description: "Sync data from Postgres partitioned tables using wildcard table name matching in Sync Streams, with patterns for time-partitioned and list-partitioned data."
---
