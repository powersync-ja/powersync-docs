...
description: "Design legacy Sync Rules to organize data into global, user-filtered, and group-shared buckets for efficient sync and per-user data isolation."
---
