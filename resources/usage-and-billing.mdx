...
4. Upgrade your [PowerSync plan](https://www.powersync.com/pricing)
   * The ability to downgrade or cancel your plan is coming soon — in the mean time, please [contact us](/resources/contact-us) for this.
...
Instances on the Free plan that have had no deploys or client connections for over 14 days will be paused. This helps us optimize our cloud resources and ensure a better experience for all users.

If your instance is paused, you can easily resume it from the [Dashboard](/usage/tools/powersync-dashboard) or [CLI](/usage/tools/cli) by deploying a sync rules update to it.
