...
2. **Share Documentation**: Include links to specific PowerSync documentation pages and/or repos relevant to your task
3. **Clarify Your Schema**: Describe your app's schema/data model and sync requirements clearly
4. **Define Sync Rules**: If applicable, share your sync rules to help the AI understand your data flow
