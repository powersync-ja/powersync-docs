...
description: "Configure self-hosted PowerSync Service deployments using YAML or environment variables."
...
With [storage version 4](/sync/advanced/storage-version-4) (Beta), you can move larger blocks of sync data from MongoDB to Amazon S3 or an S3-compatible object store. See [S3 object storage](/sync/advanced/storage-version-4#s3-object-storage) for configuration.
