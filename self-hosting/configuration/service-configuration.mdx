...
Specify the connection to your source database in the `replication` section. For details on connecting to your database, see the [Connect PowerSync to your Database](/installation/quickstart-guide#connect-powersync-to-your-database) section in the Quickstart Guide.
...
Your project's [sync rules](/usage/sync-rules) can either be specified within your configuration file directly, or in a separate file that is referenced.
