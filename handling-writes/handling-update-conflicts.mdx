...
description: "Understand what happens when multiple users update the same records while offline and how PowerSync resolves conflicts using last-write-wins."
---
