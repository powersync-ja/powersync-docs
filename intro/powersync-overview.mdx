...
description: "PowerSync is a sync engine that keeps your backend database in sync with in-app SQLite for offline-first apps across mobile, web, and desktop."
