...
description: "Filter synced data dynamically using subscription, auth, and connection parameters in Sync Streams queries."
---
...
Specified "globally" at the connection level, before any streams are subscribed. Use them when you need a value that applies across all streams for the session.
