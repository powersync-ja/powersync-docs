...
- **Sync Test** - Test your Sync Streams or Sync Rules configuration
...
- **Edit and deploy Sync Streams / Sync Rules** - Select your project and instance and go to the **Sync Streams** (or **Sync Rules**) view to edit your sync config, then click **"Validate"** and **"Deploy"** to deploy
