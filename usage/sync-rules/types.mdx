...
| `DOMAIN` types     | text / depends                 | Depends on [compatibility options](/usage/sync-rules/compatibility#custom-postgres-types)                                                                                                                                               |
| Custom types       | text                           | Depends on [compatibility options](/usage/sync-rules/compatibility#custom-postgres-types)                                                                                                                                               |
| (Multi-)ranges     | text                           | Depends on [compatibility options](/usage/sync-rules/compatibility#custom-postgres-types)                                                                                                                                               |
...
<Info>
    ...
    See [Operators & Functions](/usage/sync-rules/operators-and-functions)
</Info>
