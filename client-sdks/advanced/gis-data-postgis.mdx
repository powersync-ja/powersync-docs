...
description: "Sync PostGIS geographic data through PowerSync as WKB or GeoJSON and query it on the client using SQLite spatial extensions and helper functions."
---
