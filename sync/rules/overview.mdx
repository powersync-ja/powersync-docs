...
description: "Understand legacy Sync Rules for controlling which data syncs to each client, including bucket definitions, parameter queries, and data queries."
---
