...
description: "Railroad diagram reference for the SQL grammar supported in legacy Sync Rules queries."
---

<Info>
Sync Rules are deprecated. For the Sync Streams version of this page, see [Grammar Reference](/sync/grammar/sync-streams/index).
</Info>

This page is a formal grammar reference for Sync Rules: it shows the syntax accepted for parameter queries and data queries using railroad diagrams. This page complements the [Supported SQL](/sync/rules/supported-sql) guide, which explains in prose what you can write, with examples and restrictions.
