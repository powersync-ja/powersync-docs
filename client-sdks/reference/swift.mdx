...
```text
Set up PowerSync in this project using the PowerSync Swift SDK.

Install the PowerSync Agent Skills in this project and follow them:

    npx skills add powersync-ja/agent-skills

Use https://docs.powersync.com/client-sdks/reference/swift.md as the SDK
reference. When something is unclear, check the PowerSync docs or ask me. Do
not invent APIs.
...
5. Which Apple platforms am I targeting, and am I using SwiftUI or UIKit?
