...
| **Flutter**                   | [powersync\_attachments\_helper](https://pub.dev/packages/powersync_attachments_helper) (legacy) and [`powersync_core` attachments](https://github.com/powersync-ja/powersync.dart/tree/main/packages/powersync_core/doc/attachments.md) | [To-Do List demo app](https://github.com/powersync-ja/powersync.dart/tree/main/demos/supabase-todolist)          |
