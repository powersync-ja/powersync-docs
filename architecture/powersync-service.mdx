...
description: "How the PowerSync Service replicates data from your source database into buckets and delivers real-time, low-latency sync to connected clients."
---
