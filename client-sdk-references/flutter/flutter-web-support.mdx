...
1. Clone [the powersync.dart repo](https://github.com/powersync-ja/powersync.dart/tree/main).
...
OPFS is the preferred mode when it is available. Otherwise file storage falls back to IndexedDB.
