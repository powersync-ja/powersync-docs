...
description: "Configure your app backend to process client-side mutations from the upload queue and optionally generate JWTs for PowerSync authentication."
