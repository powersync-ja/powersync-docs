...
description: "Connect a PowerSync Cloud instance to your Postgres, MongoDB, MySQL, or SQL Server source database, including connection strings, SSL, and credentials."
---
