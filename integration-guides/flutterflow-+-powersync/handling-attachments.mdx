...
- Syncing both attachment metadata and the actual files between local and remote storage using PowerSync.
- Providing a file operations API with methods to add, remove, and retrieve attachments, maintaining consistency across local and remote storage.
