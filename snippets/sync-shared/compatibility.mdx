{/* Shared body: rendered by sync/advanced/compatibility.mdx (Sync Streams section) and sync/rules/compatibility.mdx (Sync Rules (Legacy) section). Keep the content valid for both engines. */}
