...
4. Under **"App Settings" -> "Project Dependencies" -> "FlutterFlow Libraries"** click "Add Library".
   ...
   2) Select the "PowerSync" library.
   ...
   3) Add your schema:
      ...
      2) On the PowerSync Dashboard, right-click on your instance and select "Generate Client-Side Schema" and select "FlutterFlow" as the language.

   4) Copy and paste your PowerSync instance URL into the "PowerSyncURL" field.
