...
description: "Integration guide for creating offline-first apps with FlutterFlow and PowerSync with Supabase as the backend."
...
<Frame>
  <img src="/images/integration-20.png"/>
</Frame>

1. Give your instance a name, such as "Supabase Testing".
2. Under the "**General**" tab, you can change the default cloud region from US to EU or JP if desired (more cloud regions are available, [contact us](/resources/contact-us) if you need a different region).
...
<Frame>
  <img src="/images/integration-22.avif"/>
</Frame>
1. Replace the `sync-rules.yaml` file's contents with the below:

```bash This will sync the entire table to all users - we will refine this later
...
<Frame>
  <img src="/images/integration-23.png"/>
</Frame>
...
<Frame>
  <img src="/images/integration-28.png"/>
</Frame>
...
<Frame caption="For once a blank screen means success">
  <img src="/images/integration-30.avif"/>
</Frame>
...
<Frame>
   <img src="/images/Screenshot 2024-10-07 at 16.36.10.png"/>
</Frame>
...
<Frame>
   <img src="/images/integration-36.png"/>
</Frame>
...
<Frame>
   <img src="/images/integration-38.png"/>
</Frame>
...
<Frame>
   <img src="/images/integration-41.png"/>
</Frame>
...
5. <Frame>
      <img src="/images/integration-46.png"/>
   </Frame>
...
<Frame>
   <img src="/images/integration-59.png"/>
</Frame>
...
2. On the Widget Palette again, add a Container child to the Column Widget.
   ...
   3. Your homepage layout should now look like this:
<Frame>
   <img src="/images/integration-62.png"/>
</Frame>
...
<Frame>
   <img src="/images/integration-67.png"/>
</Frame>
<Frame>
   <img src="/images/integration-69.png"/>
</Frame>
