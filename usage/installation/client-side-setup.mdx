...
2. [Define your Schema](/usage/installation/client-side-setup/define-your-schema)
3. [Instantiate Local PowerSync Database](/usage/installation/client-side-setup/instantiate-powersync-database)
4. [Integrate with your Backend](/usage/installation/client-side-setup/integrating-with-your-backend) \[Optional\]
   1. Download data from your database
   2. Write mutations to your backend

PowerSync currently supports apps built in [Flutter](/client-sdk-references/flutter), [React Native & Expo](/client-sdk-references/react-native-and-expo), [JS Web](/client-sdk-references/js-web), [Kotlin](/client-sdk-references/kotlin-multiplatform) (beta), and [Swift](/client-sdk-references/swift) (alpha). Please see the steps based on your type of app:
...
Add the [PowerSync JS Web NPM package](https://www.npmjs.com/package/@powersync/web) to your project:
...
* See the [Developer Notes](/client-sdk-references/js-web#developer-notes) section in the SDK reference for details about connecting with either method.
...
<Card
    ...
    icon="js"
    href="/client-sdk-references/js-web"
    horizontal
/>
...
1. Install `powersync-sqlite-core` cocoapod in `Podfile` (this pod is required to set up the local database correctly)

```bash
target 'YourTargetName' do
  ...
  pod 'powersync-sqlite-core', '~> 0.1.8'
end
```

Install the package using `Package.swift` file or using XCode:
...
1. In XCode:
   ...
   2. When searching for the package use [https://github.com/powersync-ja/powersync-kotlin.git](https://github.com/powersync-ja/powersync-kotlin.git) as the URL and include the exact version `1.0.0-BETA1.0` as shown below:

<Frame>
    <img src="/images/usage-15.avif"/>
</Frame>
<Note>
    Use the exact version as we are actively making changes to the Swift SDK which could result in breaking changes.
</Note>
...
1. [Define your Schema](/usage/installation/client-side-setup/define-your-schema)
2. [Instantiate PowerSync Database](/usage/installation/client-side-setup/instantiate-powersync-database)
3. [Integrate with your Backend](/usage/installation/client-side-setup/integrating-with-your-backend)
