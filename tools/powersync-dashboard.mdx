...
- **Client SDK Setup** - Generate the [client-side schema](/installation/client-side-setup/define-your-schema) based off your [Sync Rules](/sync/rules/overview)
...
- **Generate client-side schema** - Click the **Connect** button in the top bar to generate the [client-side schema](/installation/client-side-setup/define-your-schema) based on your [Sync Rules](/sync/rules/overview) in your preferred language
