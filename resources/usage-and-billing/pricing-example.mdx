...
description: "Worked example showing how PowerSync Cloud plan costs are calculated based on synced operations, active users, sync data volume, and add-on features."
---
