...
description: "Sync JSON, JSONB, arrays, and other custom Postgres types through PowerSync by serializing them to text."
---
...
Add your JSON column as a `text` column in your client-side schema definition. For advanced update tracking, see [Advanced Schema Options](#advanced-schema-options-to-process-writes).
...
Add your array column as a `text` column in your client-side schema definition. For advanced update tracking, see [Advanced Schema Options](#advanced-schema-options-to-process-writes).
...
Add your custom type column as a `text` column in your client-side schema definition. For advanced update tracking, see [Advanced Schema Options](#advanced-schema-options-to-process-writes).
