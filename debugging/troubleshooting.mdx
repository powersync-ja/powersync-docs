...
For the full model of how streams create buckets, how to count them, every reduction strategy, and how to raise the limit, see [Bucket Count and Limits](/sync/streams/bucket-count).
