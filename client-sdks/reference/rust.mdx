...
```text
Set up PowerSync in this project using the PowerSync Rust SDK.

Install the PowerSync Agent Skills in this project and follow them:

    npx skills add powersync-ja/agent-skills

Use https://docs.powersync.com/client-sdks/reference/rust.md as the SDK
...
5. What kind of application is this, and how is the Rust code packaged into
   it?
