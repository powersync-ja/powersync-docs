...
description: "Deploy the self-hosted PowerSync Service with a custom backend on Railway using Docker images, environment variables, and the Railway database add-on."
