...
<CardGroup>
  ...
  <Card title="Example Projects" icon="code" href="/resources/demo-apps-example-projects#kotlin-sdk">
...
run SQL queries.
For details, see the [SQL Library Support](/client-sdk-references/kotlin-multiplatform/libraries/overview) page.
