...
description: "Railroad diagram reference for the SQL grammar supported in legacy Sync Rules queries, including bucket definitions, parameter queries, and data queries."
---
