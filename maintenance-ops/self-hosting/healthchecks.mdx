---
title: "Health Checks"
description: "Configure startup and liveness health check endpoints for self-hosted PowerSync Service deployments, including Docker Compose configuration."
---
