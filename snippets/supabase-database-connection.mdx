...
3. In the [PowerSync Dashboard](https://dashboard.powersync.com/), select your project and instance and go to **Database Connection**.
4. Select the **Postgres** tab.
...
8. Verify your setup by clicking **Test Connection** and resolve any errors.
