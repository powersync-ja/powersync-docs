...
description: "Migrate users between self-hosted PowerSync instances with minimal downtime, including data copying, DNS cutover, and client reconnection strategies."
---
