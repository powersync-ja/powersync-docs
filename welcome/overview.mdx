...
Below is a brief introduction to PowerSync, followed by our most popular developer resources. 

<Note>
If you can't find what you are looking for, use the searchbar or navigation. If you are still lost, ask your question on our [community Discord](https://discord.gg/powersync) where our team is ready to help!
</Note>
...
<CardGroup cols={3}>
  <Card title="Postgres (stable)" icon="elephant" href="../usage/installation/database-setup/#postgres">
  </Card>
  <Card title="MongDB (alpha)" icon="leaf" href="../usage/installation/database-setup/#mongodb-alpha">
  </Card>
  <Card title="MySQL (private alpha)" icon="dolphin">
  </Card>
</CardGroup>
