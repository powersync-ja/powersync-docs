...
<Frame caption="Self-hosted PowerSync architecture">
  <img src="/images/self-hosting-1.avif"/>
</Frame>
...
<CardGroup>
 <Card title="Configure source database" icon="database" href="/usage/installation/database-setup"horizontal />
...
<Card title="Import PowerSync client SDK" icon="file-import" href="/usage/installation/client-side-setup"horizontal />
<Card title="Set up app backend" icon="server" href="/usage/installation/app-backend-setup"horizontal />
</CardGroup>
