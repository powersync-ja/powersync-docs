...
<Info>
   For a quick way to get started before implementing custom auth, [Development Tokens](/usage/installation/authentication-setup/development-tokens) can be used instead.
</Info>
