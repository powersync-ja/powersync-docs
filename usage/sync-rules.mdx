...
<Note>
  **Sync Streams (Early Alpha)** are now available as the next evolution of Sync Rules, offering on-demand syncing and improved developer experience. [Learn more about Sync Streams](/usage/sync-streams.md). Sync Rules will continue to be supported for the foreseeable future.
</Note>
