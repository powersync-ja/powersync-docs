...
description: "Learn how to perform a cascading delete on the client."
...
<Note>
    An important thing to note is that the local SQLite database will always match the backend source database, as long as the tables are in the publication, when online.
