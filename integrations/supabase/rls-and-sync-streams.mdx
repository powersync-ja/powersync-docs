...
description: "Understand how PowerSync Sync Streams work alongside Supabase Row Level Security policies to enforce per-user access control on synced data."
---
