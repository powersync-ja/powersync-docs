...
description: "Set up Stytch authentication with Supabase as the auth provider for PowerSync, using Stytch-issued JWTs and Supabase as the source database."
---
