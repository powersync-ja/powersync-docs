...
description: "Links to example projects built with PowerSync."
---

Example projects are listed under the backend they use, but you can easily wire up your own backend as documented [here](/usage/installation/app-backend-setup).
...
## <Icon icon="js" size="22" iconType="solid"/> JS Web
...
## <Icon icon="code" size="22" iconType="solid"/> Kotlin Multiplatform
...
* [To-Do List App with Docker Compose](https://github.com/powersync-ja/self-host-demo)
   * [Node.js Backend](https://github.com/powersync-ja/self-host-demo/tree/main/demos/nodejs)
...
* Expo Web
   ...
   * Note: we're busy working on first class support for React Native Web which will remove the need to _"Patch the_  _`@powersync/web`_ _module"_
