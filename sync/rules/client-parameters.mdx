...
description: "Pass dynamic parameters from the client SDK directly into Sync Rules queries to filter data per user, device, or application context."
---

<Info>
Sync Rules are deprecated. For the Sync Streams equivalent, see [Connection Parameters](/sync/streams/parameters#connection-parameters).
</Info>
