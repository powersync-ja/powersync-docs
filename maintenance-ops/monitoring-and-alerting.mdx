...
* **Compact logs**: Reflect the [compacting](/maintenance-ops/compacting-buckets) jobs that run daily to keep your instance's sync buckets efficient.

* **Migration logs**: Reflect the migration job that prepares your instance's storage during a deploy. Check these when a deploy fails.
