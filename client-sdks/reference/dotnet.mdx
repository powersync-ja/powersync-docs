...
```text
Set up PowerSync in this project using the PowerSync .NET SDK.

Install the PowerSync Agent Skills in this project and follow them:

    npx skills add powersync-ja/agent-skills

Use https://docs.powersync.com/client-sdks/reference/dotnet.md as the SDK
...
5. Which .NET version and app framework am I using (for example MAUI or a
   console app)? Check the supported frameworks and targets on the SDK
   reference first.
