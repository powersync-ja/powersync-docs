...
1. Define how PowerSync's [schemaless protocol](/architecture/powersync-protocol#protocol) maps into your raw tables — see [Define sync mapping for raw tables](#define-sync-mapping-for-raw-tables)
