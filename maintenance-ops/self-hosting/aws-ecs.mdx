...
Set the minimum and maximum number of API tasks. Calculate your minimum capacity based on expected peak connections:

```
min_tasks = ceil(peak_concurrent_connections / 100)
```

For example, if you expect up to 500 concurrent connections, set `min-capacity` to 5:
