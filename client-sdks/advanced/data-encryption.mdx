...
description: "Secure client-side data with encryption in transit via TLS and at rest for SQLite databases, with platform-specific setup for Flutter and other SDKs."
---
