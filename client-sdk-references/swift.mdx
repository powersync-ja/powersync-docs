...
<Tabs>
<Tab title="SDK version 1.5.0 and up">
Version 1.5.0 of the SDK introduced Swift 6 strict concurrency checking, which deprecated the default `PowerSyncBackendConnector` class. Use `PowerSyncBackendConnectorProtocol`:

```swift
import PowerSync

class MyConnector: PowerSyncBackendConnectorProtocol {
