...
description: "Handle different client app versions that require different output schemas from Sync Streams, with versioning strategies and compatibility tips."
---
