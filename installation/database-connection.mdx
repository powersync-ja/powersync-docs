...
<Check>
   SQL Server support was introduced in version 1.18.0 of the PowerSync Service, which is currently available in the [**Next** channel](resources/feature-status#powersync-cloud).
</Check>
