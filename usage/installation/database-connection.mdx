...
Details for MongoDB are coming soon. In the meantime, check our [MongoDB guide](/resources/migration-guides/mongodb-atlas) to try out our MongoDB alpha support in PowerSync Open Edition, and ask on [our Discord](https://discord.gg/powersync) if you have any questions.
