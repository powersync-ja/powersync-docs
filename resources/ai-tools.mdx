...
For any page within our documentation, you can obtain the Markdown version, which is more easily readable by AI tools. There are several methods to do this:
