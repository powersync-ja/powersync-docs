<CodeGroup>
  ...
  <Note>An object initializer syntax is also available as an alternative. See the [.NET SDK reference](/client-sdks/reference/dotnet#schema-definition-syntax) for details.</Note>
