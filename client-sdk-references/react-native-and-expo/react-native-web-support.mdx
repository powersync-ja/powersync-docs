...
description: "[React Native for Web](https://necolas.github.io/react-native-web/) enables developers to use the same React Native codebase for both mobile and web platforms."
---

Support for React Native Web is available since versions 1.12.1 of the [PowerSync React Native SDK](/client-sdk-references/react-native-and-expo) and 1.8.0 if the [JavaScript/Web SDK](/client-sdk-references/js-web), and is currently in a **beta** release.

A demo app showcasing this functionality is available here:
<Card
  title="powersync-js/demos/react-native-web-supabase-todolist at main · powersync-ja/powersync-jsGitHub"
  icon="github"
...
The [PowerSync Web SDK](/client-sdk-references/js-web), alongside the [PowerSync React Native SDK](/client-sdk-references/react-native-and-expo), is required for Web support.
