...
description: "Compare SQL mapping libraries for the PowerSync Kotlin Multiplatform SDK, including Room and SQLDelight, to choose the best query layer for your app."
