...
```text
Set up PowerSync in this project using the PowerSync Dart/Flutter SDK.

Install the PowerSync Agent Skills in this project and follow them:

    npx skills add powersync-ja/agent-skills

Use https://docs.powersync.com/client-sdks/reference/flutter.md as the SDK
...
5. Which platforms am I targeting: iOS, Android, web, or desktop? If web is
   one of them, follow the extra steps in
   https://docs.powersync.com/client-sdks/frameworks/flutter-web-support.md.
