...
- [**Dart/Flutter SDK**](/client-sdks/guides/flutter): Uses the [sqlite_async](https://pub.dev/documentation/sqlite_async/latest/) package for migrations
- [**JavaScript Web SDK**](/client-sdks/guides/javascript-web): Requires version 0.5.0 or greater (including [wa-sqlite](https://github.com/powersync-ja/wa-sqlite) 0.2.0+)
- [**React Native SDK**](/client-sdks/guides/react-native-and-expo): Requires version 1.16.0 or greater (including [@powersync/react-native-quick-sqlite](https://github.com/powersync-ja/react-native-quick-sqlite) 2.2.1+)
- [**Swift SDK**](/client-sdks/guides/swift)
