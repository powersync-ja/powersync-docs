...
Once enabled, restart the service and the metrics endpoint will return Prometheus-formatted metrics, as described in the [What is Collected](/self-hosting/lifecycle-maintenance/telemetry#whatiscollected) section of the [Telemetry](/self-hosting/advanced/telemetry) docs.
