...
1. `fetchCredentials()` — This is called every couple of minutes and is used to obtain JWT credentials from your app backend API. See [Authentication Setup](/usage/installation/authentication-setup) for instructions on how the credentials should be generated.
...
* [3\. Integrate with your Backend](/client-sdk-references/js-web#id-3.-integrate-with-your-backend)
