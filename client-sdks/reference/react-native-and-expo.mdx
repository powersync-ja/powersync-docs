...
description: "Use PowerSync in React Native and Expo apps to build offline-first iOS and Android clients with reactive watch queries and a managed SQLite database."
