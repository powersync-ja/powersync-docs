...
To make this step easy for you, the [PowerSync Dashboard](https://dashboard.powersync.com/) allows automatically generating the client-side schema based on the Sync Rules defined for a PowerSync instance. To generate the schema, click the **Connect** button in the top bar to generate the client-side schema based on your Sync Rules in your preferred language. Alternatively you can use the PowerSync [CLI](/usage/tools/cli) to generate the schema.
