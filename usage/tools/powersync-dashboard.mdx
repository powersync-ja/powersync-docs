...
Customers on our [Team and Enterprise plans](https://www.powersync.com/pricing) can lock their PowerSync Cloud deployments to a specific version of the PowerSync Service. This option is available under your instance settings. 
