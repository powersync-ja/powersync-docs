...
<Accordion title="Alternative: Fixed Capacity (No Custom Metrics)">

If you prefer not to set up the CloudWatch Agent sidecar and custom metrics, you can calculate a fixed minimum task count based on your expected peak connections:
...
This approach is simpler but means you pay for peak capacity at all times, even during low-traffic periods.
