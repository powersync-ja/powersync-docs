...
description: "Use PowerSync in JavaScript web apps to build offline-first browsers clients with WASM SQLite, OPFS storage, and shared worker multi-tab support."
