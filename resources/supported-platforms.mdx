...
description: "Supported platforms and feature availability for each PowerSync Client SDK across iOS, Android, web, desktop, and server runtimes, with version requirements."
---
