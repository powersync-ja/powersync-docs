...
description: "Query JSON data synced from your backend and stored as text in SQLite using the json_extract function, JSON operators, and indexed JSON paths."
---
