...
For the beta, we are moving away from this Kotlin-based architecture towards more Swift-native APIs. For the stable release, we are planning to move to a fully native Swift SDK.
