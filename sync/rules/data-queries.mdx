---
title: "Data Queries"
description: "Write Data Queries in Sync Rules to select and filter data for buckets using bucket parameters."
---

<Info>
Sync Rules are deprecated. For the Sync Streams equivalent, see [Writing Queries](/sync/streams/queries).
</Info>
