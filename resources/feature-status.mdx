...
In the PowerSync Dashboard, developers can configure the service version channel for their instance. This optionis available in the Settings view for each instance.
