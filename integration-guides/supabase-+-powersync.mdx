...
2. For the value of `powersyncUrl`, click the **Connect** button in the top bar of the [PowerSync Dashboard](https://dashboard.powersync.com/) and click **Copy to clipboard** in the "Instance URL" section of the dialog.
