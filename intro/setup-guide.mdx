...
<Tabs>
  ...
  <Tab title="Self-Hosted">
    ...
    <Note>
      For more details on database connections, including provider-specific connection details (Supabase, AWS RDS, MongoDB Atlas, etc.), see [Database Connection](/self-hosting/configuration/database-connection).
    </Note>
  </Tab>
</Tabs>
