...
description: "Set up global buckets in Sync Rules to sync shared reference data to all connected users without per-user filtering or parameter queries."
---

<Info>
Sync Rules are deprecated. For the Sync Streams equivalent, see [Global Data](/sync/streams/quickstart#global-data) in the Sync Streams Quickstart.
</Info>
