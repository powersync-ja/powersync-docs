...
<Warning>
    ...
    - Read through the [Service Configuration](/configuration/powersync-service/self-hosted-service)
...
<AccordionGroup>
  ...
  <Accordion title="Step 3: Update config files" defaultOpen={false}>
        ...
        the skeleton config file in [Service Configuration](/configuration/powersync-service/self-hosted-service).
        <Frame>
