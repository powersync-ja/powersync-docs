---
title: "CLI"
description: "Manage PowerSync Cloud and self-hosted instances from the command line with the CLI for sync rules deployment, diagnostics, and configuration."
---
