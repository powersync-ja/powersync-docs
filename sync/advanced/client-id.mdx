---
title: "Client ID"
description: "Understand PowerSync's requirement for a single text-type primary key column called id and strategies for mapping non-UUID source database keys."
---
