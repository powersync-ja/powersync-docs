...
description: "Implement client-side full-text search using SQLite's FTS5 extension with PowerSync."
---
...
- [**React Native SDK**](/client-sdks/reference/react-native-and-expo): Requires version 1.16.0 or greater.
