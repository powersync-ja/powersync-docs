---
title: "Diagnostics"
description: "Use the PowerSync Diagnostics API on self-hosted instances to inspect replication status, sync health, bucket state, and active client connections."
---
