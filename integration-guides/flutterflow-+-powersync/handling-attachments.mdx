...
6. Still under the **"Widget Tree"**, select the `ListImage` component.
   ...
   5. As the "Table Name" specify `lists` .
   6. Click "Confirm".
...
8. Back under the **"Widget Tree"**, select the `Image` widget.
   1. In the **"Properties"** panel on the right, enable "Conditional" under "Visibility".
      ...
      6. Check "Nullable".
      7. Click on "UNSET" under "Value".
      8. Select the "Component Parameter" -> `list` variable.
      9. Under "Supabase Row Fields" select "photo_id".
      10. Click "Confirm".
      11. Set the "Expression" to `photo != null`.
      12. Ensure there are no errors.
      13. Click "Confirm".
...
9.  Under the **"Widget Tree"**, select the `ListImage` component. 
    ...
    13. Under "Value to set" click on "UNSET" and select the "Action Outputs" -> `photo` variable.
    14. Click "Confirm".
...
10. Under the **"Widget Tree"**, select the "Button" widget.
    ...
    10. Click "Confirm".
    11. Under the "picture" argument, under "Value", click on "UNSET".
    12. Select the "Widget State" -> "Uploaded Local File" variable.
    13. Click "Confirm".
11. Chain another action, search for "update com" and select "Update Component State".
    ...
    4.  Under "Value to set" click on "UNSET" and select the "Widget State" -> "Uploaded Local File" variable.
    5.  Click "Confirm".
