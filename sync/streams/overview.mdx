---
title: "Sync Streams"
description: "Introduction to Sync Streams, the recommended way to define which data syncs to each client with SQL-based stream definitions and filtering."
