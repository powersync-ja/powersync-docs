...
{/* Split page: the Sync Rules (Legacy) version of this page is sync/rules/partitioned-tables.mdx. That page is deprecated and frozen, but when you fix an error here, check whether it needs the same fix. Do not mention Sync Rules on this page. */}
