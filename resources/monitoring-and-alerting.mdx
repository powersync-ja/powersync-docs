...
* **Monitor Service and Replication Activity**: Track your PowerSync service and replication logs with [instance-logs](monitoring-and-alerting.md#instance-logs)
* **Configure Alerts**: Set up alerts for connection issues or usage activity \*
  * Includes [issue-alerts](monitoring-and-alerting.md#issue-alerts) and/or [metric-alerts](monitoring-and-alerting.md#metric-alerts)
* **Webhooks**: Set up [webhooks](monitoring-and-alerting.md#webhooks) to report events (like issue or metric alerts) to external systems \*
...
Access instance logs through the [Dashboard](../usage/tools/powersync-dashboard.md), in the **Instance logs** workspace (or by searching for the panel using the [command palette](../usage/tools/powersync-dashboard.md#the-command-palette)):
...
This command and other configuration options are also available from the [command palette](../usage/tools/powersync-dashboard.md#the-command-palette) (SHIFT+SHIFT):
...
See [#webhooks](monitoring-and-alerting.md#webhooks "mention") below to notify external systems when an alert is triggered.
...
After creating a webhook, a secret is automatically generated and copied to your clipboard. Store this secret since you'll need it to verify the webhook request signature. See [#webhook-signature-verification](monitoring-and-alerting.md#webhook-signature-verification "mention")
