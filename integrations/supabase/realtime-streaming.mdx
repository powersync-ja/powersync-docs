---
title: "PowerSync and Supabase Realtime"
description: "Understand how PowerSync's local database sync differs from subscribing to Postgres changes with Supabase Realtime."
---

[Supabase Realtime's Postgres Changes](https://supabase.com/docs/guides/realtime/postgres-changes) lets clients subscribe to database events. PowerSync takes a different approach: Sync Streams sync a selected subset of your Supabase Postgres data into client-side SQLite, which your app reads directly.
