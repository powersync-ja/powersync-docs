---
title: "Swift SDK"
description: "Complete setup and usage guide for the PowerSync Swift SDK, covering installation, schema definition, database connection, and sync configuration."
