...
description: "Use the PowerSync Cloud Dashboard to manage instances, configure Sync Streams, monitor usage, view diagnostics, and administer your PowerSync project."
---
