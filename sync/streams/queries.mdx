...
description: "Learn Sync Streams query syntax for filtering with subqueries and joins, selecting columns, transforming types, and building efficient sync rules."
