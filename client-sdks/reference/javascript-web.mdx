...
```text Build with AI icon="sparkles"
Install the PowerSync Agent Skills with: npx skills add powersync-ja/agent-skills

Then follow the skills to onboard this project to PowerSync using the
JavaScript Web SDK.
```
