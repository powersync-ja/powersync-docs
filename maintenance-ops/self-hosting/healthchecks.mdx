---
title: "Health Checks"
description: "Configure HTTP health check endpoints for self-hosted PowerSync Service deployments to support load balancers, Kubernetes probes, and uptime monitoring."
---
