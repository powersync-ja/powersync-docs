...
<Card title="TanStack React Query | PowerSync JavaScript SDK Docs" icon={<img src="/images/logo.png"/>} href="https://powersync-ja.github.io/powersync-js/tanstack-react-query-sdk" horizontal />
