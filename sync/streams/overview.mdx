---
title: "Sync Streams"
description: "Introduction to Sync Streams, the recommended way to define which data syncs to each client with SQL-based stream definitions."
...
You can also use inline `sync_config: content: |` with the YAML nested in your main config. See [Self-Hosted Instance Configuration](/configuration/powersync-service/self-hosted-instances#sync-streams) for both options.
</Tab>
</Tabs>
