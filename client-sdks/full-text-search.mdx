...
description: "Implement client-side full-text search using SQLite's FTS5 extension with PowerSync, including index setup, ranking, and triggers for automatic updates."
---
