---
title: ".NET SDK (beta)"
description: "Use PowerSync in .NET apps to add offline-first sync to MAUI, Avalonia, and other .NET clients with SQLite storage and reactive query support (beta)."
