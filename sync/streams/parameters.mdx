...
If your JWT or connection parameters contain an array of values (like project IDs), you can expand them to filter data. There are three equivalent ways to write this:
