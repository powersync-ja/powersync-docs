---
title: "Drizzle"
description: "Use the Drizzle ORM with PowerSync's JavaScript and React Native SDKs for type-safe queries, schema definitions, and live updates from local SQLite."
---
