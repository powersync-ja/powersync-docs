...
2. Click **"Test Connection"** and fix any errors. If have any issues connecting, reach out to our support engineers on our [Discord server](https://discord.gg/powersync).
   1. Make sure that your database allows access to PowerSync's IPs — see [Security and IP Filtering](database-setup/security-and-ip-filtering)
3. Click **"Save".**
...
Also see:
- [MongoDB Atlas Migration Guide](../../resources/migration-guides/mongodb-atlas)