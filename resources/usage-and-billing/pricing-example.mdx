...
description: "Example showing how PowerSync Cloud plan costs are calculated based on synced operations and active users."
---
...
| ------------------------------------------ | ------------------ |
| Peak concurrent clients as % of DAUs   | 10%                |
...
|     |     |
| --- | --- |
|Total number of peak concurrent clients|5,000 DAUs * 10% = 500 peak concurrent clients|

| Total peak concurrent clients costs / month    |     |
| --- | --- |
| Usage: | 500 |
...
| Data synced | $ 0 / month |
| Data hosted | $ 2 / month |
| Peak concurrent clients | $ 0 / month |
...
|     |     |
| --- | --- |
|Total number of peak concurrent clients|100,000 DAUs * 10% = 10,000 peak concurrent clients|
...
| Peak concurrent clients | $270 / month |
...
|     |     |
| --- | --- |
|Total number of peak concurrent clients|1,000,000 DAUs * 10% = 100,000 peak concurrent clients|
...
| Peak concurrent clients | $2,970.00 / month |
