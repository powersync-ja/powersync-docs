...
description: "Configure PowerSync for React Native Web projects."
...
// The PowerSync web SDK needs to be resolved with an RN-specific export condition to work with Metro.
