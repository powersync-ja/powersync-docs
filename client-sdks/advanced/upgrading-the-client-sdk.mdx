...
Update the version number in `Package.swift` or via Xcode Package Dependencies as documented in the SDK's installation instructions: [Installation](/client-sdks/reference/swift#installation)
