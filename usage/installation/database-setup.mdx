...
Access may be restricted to specific IPs if required — see [IP Filtering](/usage/installation/database-setup/security-and-ip-filtering).
...
## MongoDB (Alpha)
<Info>
  This section is a work in progress. More details for MongoDB are coming soon. In the meantime, check our MongoDB guide to try out our MongoDB alpha support in PowerSync Open Edition, and ask on our Discord server if you have any questions.
</Info>
...
[Database Connection](/usage/installation/database-connection)

<Info>
**Self-hosting**

If you are self-hosting PowerSync, refer to [PowerSync Service Setup](/self-hosting/installation/powersync-service-setup) next.
</Info>
