...
In most cases you migrate to stay compatible first, then [adopt Sync Streams features](#adopt-sync-streams-features-over-time) such as on-demand syncing one stream at a time.
