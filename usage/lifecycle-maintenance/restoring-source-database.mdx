...
The specific behavior after a restore may vary by database type. PowerSync uses [checkpoints](/architecture/consistency#how-it-works:-checkpoints) to maintain consistency during the recovery process.
