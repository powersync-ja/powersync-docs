---
title: "CLI"
description: "Manage PowerSync Cloud and self-hosted instances from the command line, including instance creation, sync config deployment, tokens, and local development."
---
