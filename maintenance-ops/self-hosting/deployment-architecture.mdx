...
description: "Plan self-hosted PowerSync infrastructure with scaling requirements, deployment patterns, resource sizing, and high-availability considerations."
