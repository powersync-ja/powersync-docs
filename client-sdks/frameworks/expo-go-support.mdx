...
description: "Run PowerSync in Expo Go without native modules by using the @powersync/adapter-sql-js package for development and testing on managed Expo workflows."
