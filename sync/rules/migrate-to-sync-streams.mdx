...
{/* TODO: Link to the Sync Rules deprecation announcement once it is published. */}

Sync Rules are deprecated, and PowerSync is phasing them out in favor of Sync Streams. Beyond matching Sync Rules, Sync Streams add:
