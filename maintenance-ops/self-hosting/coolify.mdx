...
description: "Deploy the self-hosted PowerSync Service on Coolify with Docker Compose, including environment configuration and MongoDB setup for persistence."
---
