...
<Note>
  This package uses [`@powersync/web`](https://www.npmjs.com/package/@powersync/web) as a peer dependency. For additional `@powersync/web` configuration and instructions see the [Web SDK README](/client-sdks/guides/javascript-web).
</Note>
