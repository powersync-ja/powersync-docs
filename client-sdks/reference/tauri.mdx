...
description: "Complete setup and usage guide for the PowerSync Tauri SDK (alpha), covering installation, schema definition, database connection, and sync setup."
