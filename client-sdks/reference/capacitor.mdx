...
description: "Use PowerSync in Capacitor and Ionic apps to add offline-first sync to iOS, Android, and Web with shared code and native SQLite storage (alpha)."
