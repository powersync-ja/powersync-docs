...
<Tabs>
      ...
      <Tab title="Self-Hosted">
        **Docker (CLI)**
        ...
        The [PowerSync CLI](/tools/cli) can run PowerSync locally with Docker. Install the CLI (requires Node.js/npm), scaffold the config directory, and generate the Docker Compose setup:
