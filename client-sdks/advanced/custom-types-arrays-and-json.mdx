...
description: "Sync JSON, JSONB, arrays, and other custom Postgres types through PowerSync by serializing them to text on the server and parsing them on the client."
---
