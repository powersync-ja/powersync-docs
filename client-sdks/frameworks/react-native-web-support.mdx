...
description: "Configure PowerSync for React Native Web projects, including bundler setup, WASM SQLite support, and platform-specific entry points for shared codebases."
