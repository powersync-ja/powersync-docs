...
<CardGroup cols={3}>
  <Card title="Postgres" icon="elephant" href="../usage/installation/database-setup/#postgres">
  </Card>
  <Card title="MongoDB" icon="leaf" href="../usage/installation/database-setup/#mongodb-alpha">
  Currently in an alpha release.
  </Card>
  <Card title="MySQL" icon="dolphin">
  Currently in an alpha release.
  </Card>
</CardGroup>
