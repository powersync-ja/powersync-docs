...
It is available in all client SDKs: [Flutter v1.12.0](/client-sdk-references/flutter), [React Native v1.18.1](/client-sdk-references/react-native-and-expo), [JavaScript Web v1.24.2](/client-sdk-references/javascript-web), [Kotlin v1.0.0-BETA26](/client-sdk-references/kotlin) and [Swift v1.0.0-Beta.8](/client-sdk-references/swift).
