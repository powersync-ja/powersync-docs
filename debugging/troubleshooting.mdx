...
To diagnose and resolve this, see [Reducing Bucket Count](/sync/streams/reducing-bucket-count). For how buckets are counted in the first place, see [Bucket Count](/sync/streams/bucket-count).
