...
| Performance consideration | Shape filter design affects throughput. \[[ref](https://electric.ax/docs/sync/guides/shapes#throughput)\] | Bucket cardinality affects sync performance. \[[ref](/sync/streams/bucket-count#limits)\] |
