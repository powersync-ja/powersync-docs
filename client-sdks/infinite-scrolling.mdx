...
description: "Implement infinite scrolling in your app using PowerSync watch queries with paginated SQL queries and offset/cursor pagination against local SQLite."
---
