...
<Tabs>
  <Tab title="JavaScript/React Native/Node.js/Capacitor">
    <Note>
      **Version compatibility**: This feature requires JavaScript/Web SDK v1.x.x+, React Native SDK v1.x.x+, Node.js SDK v1.x.x+, or Capacitor SDK v1.x.x+, and PowerSync Service v1.18.x+.
    </Note>
  ...
  <Tab title="Dart/Flutter">
    <Note>
      **Version compatibility**: This feature requires Dart/Flutter SDK v1.x.x+ and PowerSync Service v1.18.x+.
    </Note>
  ...
  <Tab title="Kotlin">
    <Note>
      **Version compatibility**: This feature requires Kotlin SDK v1.x.x+ and PowerSync Service v1.18.x+.
    </Note>
  ...
  <Tab title=".NET">
    <Note>
      **Version compatibility**: This feature requires .NET SDK v1.x.x+ and PowerSync Service v1.18.x+.
    </Note>
