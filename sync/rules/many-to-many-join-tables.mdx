---
title: "Many-to-Many and Join Tables in Sync Rules"
sidebarTitle: "Many-to-Many and Join Tables"
description: "Handle many-to-many relationships in legacy Sync Rules using join table strategies, including patterns for shared resources and per-user data filtering."
---
