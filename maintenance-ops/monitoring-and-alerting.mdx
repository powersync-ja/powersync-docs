...
<Note>
  Log search is intended for ad-hoc investigation, not persistent monitoring or alerting. Repeated searches over long time ranges can place significant load on our log infrastructure, and we may apply rate limits where sustained heavy usage occurs.
</Note>
