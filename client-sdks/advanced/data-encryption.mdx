...
description: "Secure client-side data with TLS in transit and at-rest encryption for the local SQLite database using SQLCipher and per-platform encryption options."
---
