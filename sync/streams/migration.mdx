...
description: "Migrate existing PowerSync projects from legacy Sync Rules to Sync Streams, including config translation, client SDK updates, and rollout strategies."
---
