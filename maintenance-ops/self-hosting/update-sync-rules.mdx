...
description: "Update Sync Streams or legacy Sync Rules in a self-hosted PowerSync deployment, including config reloads, validation, and reprocessing implications."
---
