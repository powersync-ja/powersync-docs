...
- [Installed](/client-sdks/reference/capacitor#installation) the PowerSync Capacitor SDK.
...
- [Developer Notes](/client-sdks/reference/javascript-web#developer-notes)
