---
title: "Usage & Billing"
description: "Understand PowerSync Cloud usage-based billing."
...
<Tip>
One driver of higher usage is how your Sync Streams are structured. A row is stored and synced once per bucket it belongs to, so streams that create many buckets per user, or a global bucket synced to every user, multiply sync operations and storage. See [Reducing Bucket Count](/sync/advanced/reducing-bucket-count) to check whether this applies to you.
</Tip>
