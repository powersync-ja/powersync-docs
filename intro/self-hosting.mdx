...
See our [deployment guide](/maintenance-ops/self-hosting/coolify) for deploying the PowerSync Service on Coolify. This can simplify the setup and management of the deployment.
