...
description: "Learn how the PowerSync Client SDK manages connections, authentication, local SQLite storage, and the offline-first upload queue architecture."
---
