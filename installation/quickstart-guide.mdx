...
PowerSync is designed to be stack agnostic, and currently supports [Postgres](/installation/database-setup#postgres), [MongoDB](/installation/database-setup#mongodb) and [MySQL](http://localhost:3000/installation/database-setup#mysql-alpha) (alpha) as the backend source database, and has the following official client-side SDKs available:
...
<Steps>
  ...
  <Step title="Connect PowerSync to your Database">
    Connect your database to your instance of the PowerSync Service:
      ...
      2. Using self-hosted PowerSync: Refer to [this self-hosting](/self-hosting/installation/powersync-service-setup#powersync-configuration) section.
  </Step>
