...
description: "Choose a PowerSync SDK for web, mobile, desktop, headless, or embedded apps."
...
For getting started instructions, see our [Setup Guide](/intro/setup-guide).
