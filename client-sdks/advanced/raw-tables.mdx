...
<Note>
  **Availability**
  ...
  - **Swift**: Version 1.3.0
  - **Rust**: Supported since the initial release.
...
The standard raw table setup requires three modifications to support local-only columns:
...
<Note>
  Raw tables are not yet available in the .NET SDK.
</Note>
