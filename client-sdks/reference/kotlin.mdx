---
title: "Kotlin SDK"
description: "Use PowerSync in Kotlin Multiplatform apps to build shared offline-first code for Android, iOS, and JVM with reactive queries and managed SQLite."
