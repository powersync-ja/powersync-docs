...
<Warning>
  ...
  Because the SDK is largely built on our stable [Web SDK](/client-sdks/reference/javascript-web), that functionality is considered stable and production-ready for tested use cases. Review the [known limitations](#limitations) before using it in production.
</Warning>
