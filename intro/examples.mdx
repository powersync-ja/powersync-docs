...
<CardGroup>
  <Card title="Use Case Examples" icon="gear" href="/intro/powersync-overview" horizontal />
  <Card title="Tutorials" icon="graduation-cap" href="/intro/powersync-overview" horizontal />
</CardGroup>