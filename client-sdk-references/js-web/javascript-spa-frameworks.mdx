...
PowerSync also integrates with [TanStack Query for React](#powersync-less-than-greater-than-tanstack) (details below). This integration provides a wide range of developer tools and paves the way for future live query support in other frameworks.
