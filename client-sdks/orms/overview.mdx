...
description: "Choose a type-safe ORM or query builder for PowerSync to avoid raw SQL queries, with options across Flutter, JavaScript, Kotlin, and Swift SDKs."
---
