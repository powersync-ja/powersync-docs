...
3. The `aud` of the JWT must match the PowerSync instance URL.
   1. To get the instance URL when using PowerSync Cloud: In the [PowerSync Dashboard](https://dashboard.powersync.com/), select your project and instance, click the **Connect** button in the top bar, then click **Copy to clipboard** in the "Instance URL" section of the dialog to copy the instance URL.
