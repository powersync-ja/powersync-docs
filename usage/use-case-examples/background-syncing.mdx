...
We have done an initial investigation into how background syncing could be accomplished by using Flutter with [workmanager](https://github.com/fluttercommunity/flutter%5Fworkmanager/blob/main/README.md). However, the flow for other frameworks (e.g. React Native) should be quite similar using an equivalent package. Please reach out on our [Discord](https://discord.gg/powersync) for more assistance.

### Guide

We assume you have followed the platform setup guide in the [workmanager README](https://github.com/fluttercommunity/flutter%5Fworkmanager/blob/main/README.md#platform-setup). Note we are running this in the context of our [Supabase Todo List Demo](https://github.com/powersync-ja/powersync.dart/tree/master/demos/supabase-todolist) app.
...
At the time of writing (January 2024), we were only able to get part of this to work using the branch for [this PR](https://github.com/fluttercommunity/flutter%5Fworkmanager/pull/511) into workmanager. While testing we were not able to get iOS background fetching to work, however this is most likely an [issue](https://github.com/fluttercommunity/flutter%5Fworkmanager/issues/515) with the package.
