...
Copy this prompt into an AI coding agent (Claude Code, Cursor, Codex, or similar) to set up PowerSync with the Dart/Flutter SDK. It instructs the agent to install the [PowerSync Agent Skills](/tools/ai-tools#powersync-agent-skills) in your project and to ask about your setup before writing code.
