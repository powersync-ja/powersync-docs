---
title: "Consistency"
description: "How PowerSync uses checkpoints and causal+ consistency to atomically apply server changes on the client and order local mutations correctly."
---
