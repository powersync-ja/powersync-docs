...
```text
Set up PowerSync in this project using the PowerSync Capacitor SDK.

Install the PowerSync Agent Skills in this project and follow them:

    npx skills add powersync-ja/agent-skills

Use https://docs.powersync.com/client-sdks/reference/capacitor.md as the SDK
...
5. Which platforms am I targeting: iOS, Android, or web?
