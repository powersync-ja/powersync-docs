...
<AccordionGroup>
  ...
  <Accordion title="JavaScript Web" icon="js">
    ...
    - [Time-Based Sync Demo](https://github.com/powersync-ja/powersync-js/tree/main/demos/react-supabase-time-based-sync) - Time-based sync demo
  ...
  <Accordion title="Tauri (pre-alpha)" icon="/logo/tauri.svg">
    #### Examples
  ...
  <Accordion title="Rust (pre-alpha)" icon="rust">
    #### Examples
