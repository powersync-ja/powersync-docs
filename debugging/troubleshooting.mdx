...
streams:
  org_projects_tasks:
    ...
    queries:
      - SELECT * FROM orgs WHERE id IN (SELECT org_id FROM user_orgs)
  ...
  streams:
    assets_in_projects:
      ...
      query: |
        ...
        WHERE project_assets.project_id IN (SELECT id FROM user_projects)
  ```
  ...
  streams:
    assets_in_projects:
      ...
      query: |
        ...
        WHERE assets.org_id IN (SELECT org_id FROM org_membership WHERE user_id = auth.user_id())
  ```
