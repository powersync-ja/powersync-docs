...
description: "Configure advanced SQL Server adapter options for self-hosted PowerSync including change tracking, snapshot isolation, and polling intervals."
