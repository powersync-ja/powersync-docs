...
The best way to understand how PowerSync works is to explore it hands-on. Browse our collection of demo apps and example projects to see PowerSync in action, experiment with different features, or use as a reference four your own app your own app.
...
<AccordionGroup>
  ...
  <Accordion title="React Native & Expo" icon="react">
    ...
    * [Background Sync Demo](https://github.com/powersync-ja/powersync-js/tree/main/demos/react-native-supabase-background-sync)
      * Demonstrates [Background Syncing](/usage/use-case-examples/background-syncing) using Expo's BackgroundTask API
  ...
  <Accordion title="Self-Hosting Examples" icon="desktop">
    ...
    * [To-Do List App with Docker Compose](https://github.com/powersync-ja/self-host-demo) - React web app with various backend configurations:
      ...
      * [Node.js + Postgres + Postgres Sync Bucket Storage](https://github.com/powersync-ja/self-host-demo/tree/main/demos/nodejs-postgres-bucket-storage)
...
<Card title="GitHub - powersync-community" horizontal icon="github" href="https://github.com/powersync-community" />
