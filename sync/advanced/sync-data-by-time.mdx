---
title: "Sync Data by Time in Sync Streams and Sync Rules"
description: "Filter and sync data based on time ranges using Sync Streams or legacy Sync Rules, with patterns for recent-only and sliding-window queries."
