...
description: "Configure your app backend to authenticate users and process client-side mutations from the PowerSync upload queue back into your source database."
