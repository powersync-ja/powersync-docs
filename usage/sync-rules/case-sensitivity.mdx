...
On the client side, the case of table and column names in the [client-side schema](/usage/installation/client-side-setup/define-your-schema) must match the case produced by Sync Rules exactly. For the above example, use the following in Dart:
