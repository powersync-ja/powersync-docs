...
description: "Define bucket parameters in legacy Sync Rules using Parameter Queries with JWT claims, client parameters, and lookups against the source database."
---
