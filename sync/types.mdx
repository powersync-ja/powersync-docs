...
<Note>
    ...
    See [Operators & Functions](/sync/supported-sql)
</Note>
...
<Note>
    Binary data can be accessed in the Sync Rules, but cannot be used as bucket parameters. Before it can be synced directly to clients it needs to be converted to hex or Base64 first. See [Operators & Functions](/sync/supported-sql)
</Note>
