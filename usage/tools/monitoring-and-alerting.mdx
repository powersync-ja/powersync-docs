...
<Tabs>
  <Tab title="JavaScript/React Native/Node.js/Capacitor">
    <Note>
      **Version compatibility**: This feature requires JavaScript/Web SDK v1.x.x+, React Native SDK v1.x.x+, Node.js SDK v1.x.x+, or Capacitor SDK v1.x.x+, and PowerSync Service v1.17.0+.
    </Note>
  ...
  <Tab title="Dart/Flutter">
    <Note>
      **Version compatibility**: This feature requires Dart/Flutter SDK v1.x.x+ and PowerSync Service v1.17.0+.
    </Note>
  ...
  <Tab title="Swift">
    Support for custom metadata is not yet available in Swift.
  </Tab>

  <Tab title="Kotlin">
    <Note>
      **Version compatibility**: This feature requires Kotlin SDK v1.x.x+ and PowerSync Service v1.17.0+.
    </Note>
  ...
  <Tab title=".NET">
    <Note>
      **Version compatibility**: This feature requires .NET SDK v1.x.x+ and PowerSync Service v1.17.0+.
    </Note>
...
### Viewing Custom Metadata in Logs
...
* Metadata is set per connection. Reconnect with new metadata when user context changes (e.g., user login/logout) or when app state changes (e.g., feature flags).
