...
<Tip>
Using the [PowerSync CLI](/tools/cli) and want a managed Postgres instance? You can skip to [Step 2](#2-set-up-powersync-service-instance) and set one up automatically with the **CLI (Self-Hosted)** tab.
</Tip>
