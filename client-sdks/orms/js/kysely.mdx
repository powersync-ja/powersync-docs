---
title: "Kysely"
description: "Use the Kysely query builder with PowerSync's JavaScript and React Native SDKs for type-safe SQL queries against your local SQLite database."
---
