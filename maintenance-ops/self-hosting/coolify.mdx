...
description: "Deploy the self-hosted PowerSync Service on Coolify using Docker Compose, including database connections, environment variables, and HTTPS setup."
---
