...
description: "Build reactive UIs with live queries that automatically re-run and update your interface when underlying SQLite data changes via sync or writes."
---
