...
description: "Step-by-step guide to adding PowerSync to your app, from connecting your source database and configuring Sync Streams to integrating the client SDK."
---
