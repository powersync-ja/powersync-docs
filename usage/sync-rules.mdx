---
title: "Sync Rules"
description: "PowerSync Sync Rules allow developers to control which data gets synchronized to which devices (i.e. they enable _dynamic partial replication_)."
...
* Filter data with custom parameters (from [the JWT](/usage/installation/authentication-setup) or [from clients directly](/usage/sync-rules/advanced-topics/client-parameters-beta))
