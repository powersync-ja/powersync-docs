...
can be defined in your sync rules can be used to opt-in to fixes.
...
If you have custom postres types in your backend database schema, older versions of the PowerSync service
...
- Ranges sync as a JSON object corresponding to the following TypeScript definition:
  ...
  export type Range<T> =
    ...
    | 'empty';
  ```
- Multiranges sync as an array of ranges.
