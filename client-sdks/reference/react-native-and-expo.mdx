...
```text
Set up PowerSync in this project using the PowerSync React Native & Expo
SDK.
...
Use
https://docs.powersync.com/client-sdks/reference/react-native-and-expo.md as
...
5. Am I using Expo or bare React Native? If Expo, do I need to run the app
