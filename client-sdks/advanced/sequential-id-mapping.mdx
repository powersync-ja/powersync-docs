...
description: "Map client-generated UUIDs to server-assigned sequential IDs when your backend requires integer primary keys, while maintaining offline write support."
