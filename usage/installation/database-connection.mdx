...
1. Fill in your connection details from MongoDB:
   ...
   3. "**Username**" and "**Password**" maps to the Database user. See necessary permissions in [Source Database Setup](/usage/installation/database-setup/)
...
2. Click **"Test Connection"** and fix any errors. If have any issues connecting, reach out to our support engineers on our [Discord server](https://discord.gg/powersync).
   1. Make sure that your database allows access to PowerSync's IPs — see [Security and IP Filtering](/usage/installation/database-setup/security-and-ip-filtering)
3. Click **"Save".**
