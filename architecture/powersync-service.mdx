...
description: "Each PowerSync instance runs a copy of the PowerSync Service. The primary purpose of this service is to stream changes to clients."
---
...
* [PowerSync Overview](/overview/readme-1)
