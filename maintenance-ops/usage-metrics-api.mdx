...
description: Query usage metrics for your PowerSync Cloud instances programmatically, including storage size, concurrent clients, and replicated and synced data.
hidden: true
---
