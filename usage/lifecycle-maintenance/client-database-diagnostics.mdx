...
```shell
adb exec-out run-as com.package-name cat databases/your-db-name.sqlite > "your/path/your-db-name.sqlite"
adb exec-out run-as com.package-name cat databases/your-db-name.sqlite-wal > "your/path/your-db-name.sqlite-wal"
```
